      ...
      <section className="max-width section-padding flex flex-col tablet:flex-row gap-20 items-center">
        ...
        <div className="tablet:w-1/2 ">
          <div className="flex flex-col max-tablet:text-center gap-3">
            <p className="px-4 bg-peach-500 text-gray-600 w-max rounded tablet:w-max max-tablet:mx-auto">
              Wellcome to the world of camtivvating web development!
            </p>
            <h1 className="text-gray-700 ">I'm Sami Khan</h1>
          ...
          <div className="bg-peach-400 rounded-lg tablet:rounded-none tablet:bg-transparent tablet:border-t-2 tablet:border-b-2 tablet:border-purple w-full py-8 mt-14 tablet:mt-24 gap-12 flex flex-col tablet:flex-row">
